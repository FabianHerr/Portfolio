...
export default function RootLayout({ children }: LayoutProps<"/">) {
  return (
    <html
      lang="en"
      className={`${plexSans.variable} ${plexCondensed.variable} ${plexMono.variable} ${dseg.variable} h-full antialiased`}
    >
      <body className="flex min-h-full flex-col md:flex-row">
        ...
        <main
          id="main"
          className="flex flex-1 flex-col items-center px-4 py-12 sm:py-20 md:min-w-0"
        >
          {children}
        </main>
      </body>
